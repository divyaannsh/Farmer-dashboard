...
import NotificationsCalendar from './components/NotificationsCalendar';  // Import the component
      ...
      <div className="flex h-screen">
        ...
        <div className="flex-grow bg-gray-100">
          <Routes>
            ...
            <Route path="/notifications" element={<NotificationsCalendar />} /> {/* Add route */}
          </Routes>
        </div>
      </div>
    </Router>
